...
import {  Music2,  MessageCircle, Globe, PlayCircle, Code2 } from "lucide-react"
...
const CUSTOM_STATUS = "idk"

export default function BioLink() {
  const { data: presence } = useLanyard("1340462549338030171")
  ...
  useEffect(() => {
    ...
    toast.success("Successfully loaded @xenmo", {
      position: "top-right",
      autoClose: 5000,
  ...
  return (
    <div className="min-h-screen text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/images/IMG_0020.png" alt="Background" className="absolute inset-0 w-full h-full object-cover" />
      ...
      >
        ...
        <div className="flex justify-center space-x-4 mt-4 sm:mt-6">
          <a
            href="https://discord.com/users/1340462549338030171"
            target="_blank"
          ...
          <a
            href="https://exodevs.space/xenmo"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors"
          >
