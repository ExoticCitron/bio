...
import { CheckCircle, Music2, Github, MessageCircle, Globe, PlayCircle, Code2 } from "lucide-react"
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2">
              ...
              <div className="relative group">
                <CheckCircle className="w-5 h-5 text-white animate-pulse filter drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
