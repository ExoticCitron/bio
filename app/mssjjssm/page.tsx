...
const CUSTOM_STATUS = "kissing my homies gn"
...
export default function BioLink() {
  ...
  useEffect(() => {
    ...
    toast.success("Successfully loaded @mssjjssm", {
      position: "top-right",
      autoClose: 5000,
  ...
  return (
    <div className="min-h-screen text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-[#33C433]">
        <div className="absolute inset-0 bg-black/10" /> {/* Light overlay for better readability */}
      </div>
      ...
      <Card
        ...
        className="card-container w-full max-w-md bg-[#2f3136]/60 backdrop-blur-sm border border-[#33C433] p-4 sm:p-6 md:p-8 rounded-xl space-y-4 sm:space-y-6 relative z-10 shadow-[0_0_15px_rgba(0,0,0,0.5)] before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/10 before:to-transparent before:rounded-xl before:-z-10 transition-transform duration-200 ease-out overflow-y-auto max-h-[85vh] md:max-h-none"
        style={{
      ...
      >
        ...
        {presence?.listening_to_spotify && presence.spotify ? (
          <div className="relative group">
            ...
            <div className="relative bg-[#36393f]/40 rounded-lg p-3 sm:p-4 flex flex-col space-y-3 sm:space-y-4 border border-[#40444b]/50 shadow-[0_0_10px_rgba(0,0,0,0.2)]">
