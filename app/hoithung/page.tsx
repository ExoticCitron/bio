    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-black/40 backdrop-blur-xl border-gray-800 p-8 rounded-xl space-y-6 relative z-10">
            ...
            <div className="relative w-24 h-24">
              ...
              <div 
                className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-black translate-x-1/4 translate-y-1/4 ${
                  presence?.discord_status === 'online' ? 'bg-green-400' :
                  presence?.discord_status === 'idle' ? 'bg-yellow-400' :
                  presence?.discord_status === 'dnd' ? 'bg-red-400' :
                  'bg-gray-400'
                }`}
              />
            </div>
            ...
            <div className="relative bg-black/50 rounded-lg p-4 flex items-center justify-between border border-gray-800">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  {activity.state && (
                    <p className="text-sm text-blue-400">{activity.state}</p>
                  )}
        ...
        <div className="flex justify-center space-x-4 mt-6">
          <a href="https://github.com/ExoticCitron" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <Github className="w-6 h-6 drop-shadow-[0_0_12px_rgba(255,255,255,1)]" />
          </a>
          <a href="https://discord.com/users/1245114941610922007" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <MessageCircle className="w-6 h-6 drop-shadow-[0_0_12px_rgba(255,255,255,1)]" />
          </a>
          <a href="https://exo-devs.tech" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
